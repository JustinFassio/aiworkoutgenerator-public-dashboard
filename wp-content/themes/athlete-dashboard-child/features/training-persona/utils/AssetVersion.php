<?php
/**
 * Asset Version Management for Training Persona Feature
 * 
 * Handles versioning for training persona feature assets to ensure proper cache busting
 */

namespace AthleteDashboard\Features\TrainingPersona\Utils;
...
class AssetVersion {
    ...
    private function __construct() {
        $this->version_file = get_stylesheet_directory() . '/features/training-persona/asset-versions.json';
        $this->loadVersions();
    }
